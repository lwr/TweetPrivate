...
/**
 * A {@link junit.framework.TestCase} that can define both simple and bulk test methods.
 * <p>
 * A <I>simple test method</I> is the type of test traditionally
 * supplied by by {@link junit.framework.TestCase}.  To define a simple test, create a public
 ...
 * a subsequent call to {@link junit.framework.TestCase#run} will run that simple test.
 * <p>
 ...
 *  The ordinary {@link junit.framework.TestSuite} constructor doesn't know how to
...
public abstract class BulkTest extends TestCase implements Cloneable {
    ...
    public BulkTest clone() {
        try {
            return (BulkTest) super.clone();
    ...
    /**
     *  Returns a {@link junit.framework.TestSuite} for testing all of the simple tests
     ...
     *  in a hierarchal {@link junit.framework.TestSuite}.<P>
     *
     *  The given class must be a subclass of <code>BulkTest</code> and must
     *  not be abstract.<P>
     *
     *  @param c  the class to examine for simple and bulk tests
     *  @return  a {@link junit.framework.TestSuite} containing all the simple and bulk tests
