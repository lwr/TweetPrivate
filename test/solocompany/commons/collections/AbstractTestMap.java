 ...
 * exactly to the {@link java.util.Map} contract.  After the modification takes place
 ...
 * <b>Other Notes</b>
 * <p>
 * If your {@link java.util.Map} fails one of these tests by design, you may still use
...
public abstract class AbstractTestMap extends AbstractTestObject {
     ...
     */
    protected boolean isAllowNullKey = true;
    ...
    public void testMapContainsKey() {
        ...
        for (Object key : keys) {
            assertTrue("Map must contain key for a mapping in the map. "
                    + "Missing: " + key, map.containsKey(key));
        }
        verify();
    }
    ...
    public class TestMapEntrySet extends AbstractTestSet {
        ...
        public boolean isFailFastSupported() {
            return AbstractTestMap.this.isFailFastSupported();
        }
