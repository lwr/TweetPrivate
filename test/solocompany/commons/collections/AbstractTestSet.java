...
/**
 * Abstract test class for {@link java.util.Set} methods and contracts.
 * <p>
 * Since {@link java.util.Set} doesn't stipulate much new behavior that isn't already
 * found in {@link java.util.Collection}, this class basically just adds tests for
 * {@link java.util.Set#equals} and {@link java.util.Set#hashCode()} along with an updated
...
public abstract class AbstractTestSet extends AbstractTestCollection {
    ...
    //-----------------------------------------------------------------------
    /**
     * Tests {@link java.util.Set#equals(Object)}.
     */
